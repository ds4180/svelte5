<script>
     ...
     */
    let { width = 600, height = 400, buildingColor = "lightgray", isPathHighlighted = $bindable(false) } = $props();
...
<div class="space-y-4">
    <canvas
        ...
        {width}
        {height}
        class="border border-slate-300 w-full rounded-xl bg-white shadow-lg mx-auto block"
    ></canvas>
</div>
